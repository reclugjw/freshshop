...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('goods_sn', models.CharField(default='', max_length=100, verbose_name='商品货号')),
                ...
                ('is_hot', models.BooleanField(default=False, verbose_name='是否是热销品')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '商品信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.IntegerField(choices=[(2, '二级'), (3, '三级'), (1, '一级')], help_text='级别', verbose_name='级别')),

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('PAYING', '待支付'), ('WAIT_BUYER_PAY', '交易创建'), ('TRADE_SUCCESS', '成功'), ('TRADE_FINISHED', '交易结束'), ('TRADE_CLOSED', '超时关闭')], default='paying', max_length=30, verbose_name='订单状态')),
                ('pay_type', models.CharField(choices=[('alipay', '支付宝'), ('wechat', '微信支付')], default='alipay', max_length=30, verbose_name='支付类型')),
                ('post_script', models.CharField(max_length=50, verbose_name='订单留言')),
